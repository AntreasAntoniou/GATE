...
from gate.models.adapters.semantic_segmentation import SegmentationLossOptions
from gate.models.adapters.temporal_image_classification import Metrics
...
class Encoders(Enum):
    ...
    #     freeze_encoder=True,
    # )
    ScratchViTBase16_224 = EncoderConfig(
        pretty_name="ScratchViTBase16_224",
    ...
    ScratchResNet50A1 = EncoderConfig(
        pretty_name="ScratchResNet50A1",
    ...
    #     num_projection_features=768,
    # )
    ScratchEfficientFormer_s0 = EncoderConfig(
        pretty_name="ScratchEfficientFormer_s0",
    ...
    #     num_projection_features=768,
    # )
    ScratchEffNetV2_RW_S_RA2 = EncoderConfig(
        pretty_name="ScratchEffNetV2_RW_S_RA2",
        timm_model_name="efficientnetv2_rw_s.ra2_in1k",
        clip_model_name=CLIPModelPaths.openai_b_16,
        encoder_name="timm",
        num_projection_features=768,
    ...
    ScratchConvNextV2_Base = EncoderConfig(
        pretty_name="ScratchConvNextV2_Base",
    ...
    #     num_projection_features=768,
    # )
    ScratchFlexViTBase_1200EP = EncoderConfig(
        pretty_name="ScratchFlexViTBase_1200EP",
        timm_model_name="flexivit_base.1200ep_in1k",
        clip_model_name=CLIPModelPaths.openai_b_16,
        encoder_name="timm",
        num_projection_features=768,
...
def get_model_selection(
    ...
    output_dict = {
        ...
        #     eval_batch_size=batch_size,
        # ),
        encoder_menu.ScratchViTBase16_224.value.pretty_name: ModelConfig(
            adapter_config=adapter_config,
            encoder_config=deepcopy(encoder_menu.ScratchViTBase16_224.value)(
                image_size=image_size
            ),
            learning_rate_config=LearningRateConfig(
                default=[vit_lr], dataset_specific={}
        ...
        encoder_menu.ScratchResNet50A1.value.pretty_name: ModelConfig(
            adapter_config=adapter_config,
            encoder_config=deepcopy(encoder_menu.ScratchResNet50A1.value)(
                image_size=image_size
            ),
            learning_rate_config=LearningRateConfig(
        ...
        encoder_menu.ResNet50A1.value.pretty_name: ModelConfig(
            adapter_config=adapter_config,
            encoder_config=deepcopy(encoder_menu.ResNet50A1.value)(
                image_size=image_size
            ),
            learning_rate_config=LearningRateConfig(
                default=[vit_lr * 2], dataset_specific={}
        ...
        #     eval_batch_size=batch_size,
        # ),
        encoder_menu.ScratchFlexViTBase_1200EP.value.pretty_name: ModelConfig(
            adapter_config=adapter_config,
            encoder_config=deepcopy(
                encoder_menu.ScratchFlexViTBase_1200EP.value
            )(image_size=image_size),
            learning_rate_config=LearningRateConfig(
                default=[vit_lr], dataset_specific={}
            ),
        ...
        # ),
        encoder_menu.ScratchEfficientFormer_s0.value.pretty_name: ModelConfig(
            adapter_config=adapter_config,
            encoder_config=deepcopy(
                encoder_menu.ScratchEfficientFormer_s0.value
            )(image_size=image_size),
            learning_rate_config=LearningRateConfig(
                default=[vit_lr], dataset_specific={}
            ),
        ...
        encoder_menu.ScratchEffNetV2_RW_S_RA2.value.pretty_name: ModelConfig(
            adapter_config=adapter_config,
            encoder_config=deepcopy(
                encoder_menu.ScratchEffNetV2_RW_S_RA2.value
            )(image_size=image_size),
            learning_rate_config=LearningRateConfig(
        ...
        #     eval_batch_size=batch_size,
        # ),
        encoder_menu.ScratchConvNextV2_Base.value.pretty_name: ModelConfig(
            adapter_config=adapter_config,
            encoder_config=deepcopy(encoder_menu.ScratchConvNextV2_Base.value)(
                image_size=image_size
            ),
            learning_rate_config=LearningRateConfig(
                default=[vit_lr * 2], dataset_specific={}
