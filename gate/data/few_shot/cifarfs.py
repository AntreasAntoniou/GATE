...
class CIFARFewShotClassificationDataset(FewShotClassificationMetaDataset):
    def __init__(
        self,
        ...
        DATASET_NAME = "metadataset/cifarfs"
        super(CIFARFewShotClassificationDataset, self).__init__(
            dataset_name=DATASET_NAME,
            dataset_root=dataset_root,
            dataset_class=lambda set_name: l2l.vision.datasets.CIFARFS(
                root=dataset_root,
                mode=set_name,
                download=download,
            ),
...
def build_dataset(set_name: str, num_episodes: int, data_dir: str) -> dict:
    ...
    data_set = CIFARFewShotClassificationDataset(
        dataset_root=dataset_root,
        split_name=set_name,
        download=True,
        num_episodes=num_episodes,
