...
class DescribableTexturesFewShotClassificationDataset(
    FewShotClassificationMetaDataset
):
    def __init__(
        self,
...
def build_dataset(set_name: str, num_episodes: int, data_dir: str) -> dict:
    ...
    data_set = DescribableTexturesFewShotClassificationDataset(
        dataset_root=dataset_root,
        split_name=set_name,
        download=True,
        num_episodes=num_episodes,
...
@configurable(
    group="dataset",
    name="dtextures-fs-classification",
