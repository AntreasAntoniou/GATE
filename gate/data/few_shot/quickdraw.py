...
class QuickDrawFewShotClassificationDataset(FewShotClassificationMetaDataset):
    def __init__(
        self,
        ...
        DATASET_NAME = "metadataset/quickdraw"
        super(QuickDrawFewShotClassificationDataset, self).__init__(
            dataset_name=DATASET_NAME,
            dataset_root=dataset_root,
            dataset_class=lambda set_name: l2l.vision.datasets.Quickdraw(
                root=dataset_root,
                mode=set_name,
                download=download,
            ),
