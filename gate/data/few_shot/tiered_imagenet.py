...
class TieredImageNetFewShotClassificationDataset(
    ...
    def __init__(
        ...
        super(TieredImageNetFewShotClassificationDataset, self).__init__(
            dataset_name=DATASET_NAME,
            dataset_root=dataset_root,
            dataset_class=lambda set_name: l2l.vision.datasets.TieredImagenet(
                root=dataset_root,
                mode=set_name,
                download=download,
            ),
